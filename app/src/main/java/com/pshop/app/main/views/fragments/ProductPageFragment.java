...
import com.pshop.app.main.adapter.ProductListAdapter;
import com.pshop.app.main.contracts.ProductPageContract;
import com.pshop.app.main.models.Product;
import com.pshop.app.main.presenters.ProductPagePresenter;
import com.pshop.app.main.views.activities.MainActivity;
import com.pshop.app.main.views.customs.DynamicHeightImageView;
import com.pshop.app.main.views.customs.StaggeredSpacesItemDecoration;
import com.pshop.app.utils.AddToCartAnimation;
...
import static com.pshop.app.main.views.fragments.ProductDetailFragment.COME_FROM_PRODUCT_LIST;
...
public class ProductPageFragment extends MVPFragment<ProductPagePresenter> implements ProductPageContract.ViewImpl, AppConstans {
    ...
    private void makeFlyAnimation(ImageView targetView, final Product product) {
        ...
        final View cartView = activity.getCartView();

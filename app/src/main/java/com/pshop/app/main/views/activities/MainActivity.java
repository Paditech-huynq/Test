...
import com.pshop.app.main.presenters.MainPresenter;
import com.pshop.app.main.views.fragments.HomeFragment;
...
public class MainActivity extends MVPActivity<MainPresenter> implements MainContract.ViewImpl, AppConstans {
    ...
    public void initView() {
        ...
        addToAction(R.id.btnCart, R.id.btnNotification, R.id.imvAvatar, R.id.btnTrash, R.id.btnEdit, R.id.btnDone);
    }

...
import com.pshop.app.main.adapter.NotificationAdapter;
import com.pshop.app.main.contracts.NotificationContract;
import com.pshop.app.main.models.Notice;
import com.pshop.app.main.presenters.NotificationPresenter;
...
public class NotificationFragment extends MVPFragment<NotificationPresenter> implements NotificationContract.ViewImpl,
    ...
    @Override
    public void showMessageNotLogin() {
        showToast(this.getString(R.string.msg_notification_no_login));
    }

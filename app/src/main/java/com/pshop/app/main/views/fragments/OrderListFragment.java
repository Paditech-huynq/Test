...
import com.pshop.app.main.adapter.OrderListAdapter;
import com.pshop.app.main.contracts.OrderListContract;
import com.pshop.app.main.models.Order;
import com.pshop.app.main.presenters.OrderFragmentPresenter;
...
public class OrderListFragment extends MVPFragment<OrderFragmentPresenter> implements OrderListContract.ViewImpl {
    ...
    public void goToOrderDetailScreen(int position) {
        OrderDetailFragment orderDetailFragment = OrderDetailFragment
                .newInstance((mAdapter.getItem(position)).getId());
    ...
    public void findOrder(boolean canFind) {
        if (canFind) {
            getPresenter().getOrdersListFromServer(true);
        } else {

...
import com.pshop.app.main.views.customs.AmountView;
...
import com.pshop.app.utils.ImageHelper;
...
public class CartItemsAdapter extends BaseRecycleViewAdapter implements AppConstans {
    ...
    class CartInfoHolder extends BaseViewHolder implements Cart.CartChangeListener {
        ...
        private void setUpViewForOrderDetail() {
            ...
            Date date = new Date(mOrder.getCreatedAt() * 1000);
            tvDate.setText(Html.fromHtml(itemView.getContext().getResources().getString(R.string.cart_date_sell, DateTimeUtils.getStringTimeAll(date))));

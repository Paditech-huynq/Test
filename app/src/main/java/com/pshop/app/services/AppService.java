...
import com.pshop.app.main.models.responses.BaseRSP;
import com.pshop.app.main.models.responses.ChangeInformationRSP;
import com.pshop.app.main.models.responses.ChangePasswordRSP;
import com.pshop.app.main.models.responses.CommonRSP;
import com.pshop.app.main.models.responses.CreateCustomerRSP;
...
import com.pshop.app.main.models.responses.GetNewsCategoriesRSP;
import com.pshop.app.main.models.responses.GetNewsDetailRSP;
import com.pshop.app.main.models.responses.GetNewsRSP;
...
import com.pshop.app.main.models.responses.GetUserProfileRSP;
...
public interface AppService {
    ...
    @POST("order/create")
    @FormUrlEncoded
    Call<CreateOrderRSP> doCreatOrderForCustomer(@Header("Authorization") String token, @Header("AppKey") String appKey,
                                                 @Field("customer_id") String customerId, @Field("products") String productsList,
                                                 @Field("billing_name") String billingName, @Field("billing_date") String billingDate,
                                                 @Field("billing_phone") String billingPhone, @Field("billing_note") String billingNote,
                                                 @Field("billing_address") String address);
    ...
    @POST("member/update")
    @Multipart
    Call<ChangeInformationRSP> changeInformation(@Header("Authorization") String token, @Header("AppKey") String appKey,
                                                 @Part("name") RequestBody name, @Part("address") RequestBody address, @Part MultipartBody.Part avatar);
}

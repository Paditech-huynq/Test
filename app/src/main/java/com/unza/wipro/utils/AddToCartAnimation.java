...
public class AddToCartAnimation {
    ...
    private int mItemDuration = DEFAULT_DURATION;
    ...
    public AddToCartAnimation attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public AddToCartAnimation setTargetView(View mTarget) {
        this.mTarget = mTarget;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    public AddToCartAnimation setDestView(View mDest) {
        this.mDest = mDest;
        setDestRect(mDest.getWidth(), mDest.getHeight());
        return this;
    }

    public AddToCartAnimation setOriginRect(float originX, float originY) {
        this.originX = originX;
        this.originY = originY;
        return this;
    }

    public AddToCartAnimation setDestRect(float destX, float destY) {
        this.destX = destX;
        this.destY = destY;
        return this;
    }
    ...
    public AddToCartAnimation setMoveDuration(int mMoveDuration) {
    ...
    private AnimatorSet getAvatarRevealAnimator() {
        ...
        AnimatorSet animatorCircleSet = new AnimatorSet();
        animatorCircleSet.setDuration(mItemDuration);
        ...
        animatorCircleSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                animatorDisappearSet.setDuration(mDisapearDuration);
    ...
    public AddToCartAnimation setAnimationListener(Animator.AnimatorListener listener) {
